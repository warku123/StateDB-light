...
func (s *SdbServer) AddLogJson(ctx context.Context, in *sdb.AddLogJsonRequest) (*sdb.AddLogJsonRespond, error) {
	l := logic.NewAddLogJsonLogic(ctx, s.svcCtx)
	return l.AddLogJson(in)
}
